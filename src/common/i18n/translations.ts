export const translations: Record<string, Record<string, string>> = {
  uz: {
    ...
    'Verification code expired': 'Tasdiqlash kodining amal qilish muddati tugagan.',
    'Code sent successfully': 'Tasdiqlash kodi muvaffaqiyatli yuborildi.',
    'Email already verified': 'Elektron pochta manzili allaqachon tasdiqlangan.',
    'Please wait 1 minute before resending': 'Kodni qayta yuborishdan oldin 1 daqiqa kuting.',
    'User not found': 'Foydalanuvchi topilmadi.',
    'Invalid credentials': 'Email yoki parol noto\'g\'ri.',
    'Email already registered': 'Ushbu email manzili allaqachon ro\'yxatdan o\'tgan.',
    'Verification code is invalid or expired': 'Tasdiqlash kodi noto\'g\'ri yoki muddati tugagan.',
    'Account not verified': 'Hisobingiz hali tasdiqlanmagan. Iltimos, emailni tasdiqlang.',
  ...
  ru: {
    ...
    'Please wait 1 minute before resending': 'Подождите 1 минуту перед повторной отправкой.',
    'User not found': 'Пользователь не найден.',
    'Invalid credentials': 'Неверный email или пароль.',
    'Email already registered': 'Этот адрес электронной почты уже зарегистрирован.',
    'Verification code is invalid or expired': 'Код подтверждения недействителен или истек.',
    'Account not verified': 'Аккаунт не подтвержден. Пожалуйста, подтвердите почту.',
  ...
  for (const key in result) {
    if (Object.prototype.hasOwnProperty.call(result, key)) {
      ...
      if (typeof val === 'string' && lang !== 'en') {
        ...
        if (['name', 'description', 'message', 'error', 'fullName', 'full_name'].includes(key)) {
