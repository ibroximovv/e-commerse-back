...
export class AdminOrdersQueryDto extends PaginationQueryDto {
  ...
  @ApiPropertyOptional({ description: 'Start date filter (ISO format)', example: '2026-01-01' })
  @IsOptional()
  @IsDateString()
  start_date?: string;

  @ApiPropertyOptional({ description: 'End date filter (ISO format)', example: '2026-12-31' })
  @IsOptional()
  @IsDateString()
  end_date?: string;
